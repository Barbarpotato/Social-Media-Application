...
function EditBackground({ isOpen, onClose, overlay, dataPoint }) {
    ...
    const handleEditImage = async () => {
        ...
        const updateImageObject = { ...dataPoint, backgroundPicture: base64 }
    ...
    return (
        <React.Fragment>
            <Modal isCentered isOpen={isOpen} onClose={onClose}>
                {overlay}
                <ModalContent>
                    <ModalHeader>Edit Your Image Background</ModalHeader>
                    <ModalCloseButton />
                    <ModalBody>
                        <Input
                    ...
                    <ModalFooter>
                        <Button onClick={() => {
                            handleEditImage()
                            onClose()
                        }} isDisabled={!image} colorScheme={'purple'} >Edit Image Background</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </React.Fragment >
